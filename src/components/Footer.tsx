        ...
        <div className="max-w-7xl mx-auto px-4 py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mb-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/libro-reclamaciones" className="text-white/50 text-xs hover:text-mocha-500 transition-colors flex items-center gap-1">
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
...
function ContactItem({ icon, text }: { icon: React.ReactNode; text: React.ReactNode }) {
  return (
    <div className="flex items-start gap-3">
      <div className="w-9 h-9 rounded-full bg-mocha-500/15 flex items-center justify-center text-mocha-500 flex-shrink-0 mt-0.5">
        {icon}
      </div>
