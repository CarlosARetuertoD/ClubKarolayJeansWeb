export const WHATSAPP_NUMBER = process.env.NEXT_PUBLIC_WHATSAPP || '51940824283'
...
export const CATEGORIAS = [
  {
    ...
    imagen: '/images/catalogo/jeans.svg',
    tag: 'Lo más vendido',
  },
  {
    slug: 'casacas',
    ...
    imagen: '/images/catalogo/casacas.svg',
    tag: 'Temporada',
  },
  {
    slug: 'bermudas',
    ...
    imagen: '/images/catalogo/bermudas.svg',
    tag: 'Verano',
  },
  {
    slug: 'faldas',
    ...
    imagen: '/images/catalogo/faldas.svg',
    tag: 'Nuevo',
  },
] as const
...
export const PROMOS_DATA = [
  {
    ...
    imagen: '/images/promos/promo-landing-1.svg',
  ...
  },
  {
    ...
    cta: 'Unirme al Club',
    imagen: '/images/promos/promo-landing-2.svg',
    badge: 'Club VIP',
    color: '#ddb153',
  },
] as const
