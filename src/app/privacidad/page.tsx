    ...
    >
      ...
      <LegalSection title="5. Destinatarios, encargados y transferencias" number="05">
        ...
        <ul className="list-disc pl-5 space-y-1.5 mt-3">
          ...
          <li><strong className={strong}>Google LLC</strong> (EE. UU.) — mapa de ubicación embebido en el sitio.</li>
        </ul>
      ...
      <LegalSection title="6. Conservación" number="06">
        <p>Conservamos los datos mientras tu cuenta esté activa y sean necesarios para las finalidades informadas. Al cerrar la cuenta o tras un periodo prolongado de inactividad, los bloqueamos o eliminamos, salvo que debamos mantenerlos por los plazos de prescripción tributaria, de consumo, contable o societaria exigidos por ley (que según el supuesto pueden extenderse hasta 10 años) o para la defensa ante reclamaciones. Los datos usados exclusivamente para publicidad se dejarán de usar cuando revoques tu consentimiento, sin afectar tratamientos exigidos por ley.</p>
      </LegalSection>

      <LegalSection title="7. Seguridad e incidentes" number="07">
        <p>Aplicamos controles técnicos y organizativos razonables según el riesgo, como restricción de accesos, autenticación, comunicaciones cifradas, respaldos periódicos y registro de operaciones. Ningún sistema es infalible; ante un incidente de seguridad que pueda afectar tus datos, seguimos un procedimiento interno: contenemos el acceso no autorizado, evaluamos qué datos y personas resultaron afectadas, notificamos a la Autoridad Nacional de Protección de Datos Personales y a los titulares afectados conforme a los plazos y supuestos de la normativa aplicable, y documentamos el incidente junto con las medidas correctivas adoptadas.</p>
      </LegalSection>

      <LegalSection title="8. Cookies, sesión y medición" number="08">
        <p>La cookie necesaria ckj_auth mantiene la autenticación durante una hora. El navegador conserva también datos de presentación de la cuenta hasta cerrar sesión o borrar el almacenamiento. La cookie ckj_analytics guarda tu elección de medición durante seis meses. No registramos mediciones opcionales antes de que aceptes; puedes rechazarlas o retirar tu autorización con el botón Privacidad. La medición de visitas y clics no envía el identificador del cliente ni registra las páginas de cuenta, acceso, registro, códigos, canjes o reclamaciones. El mapa de ubicación (Google Maps) se carga directamente desde los servidores de Google en cada visita a la página donde aparece, incluso antes de elegir tus preferencias de cookies, porque es necesario para mostrar la página; no está sujeto al interruptor de medición opcional. Las tipografías del sitio se sirven desde nuestro propio dominio, no desde Google. Los registros de seguridad se tratan separadamente según su finalidad.</p>
      </LegalSection>
