...
const JEANS_DESTACADOS = [
  { nombre: 'Jean Slim Fit', desc: 'El calce favorito. Perfecto para el día a día y looks semi-formales.', imagen: '/images/catalogo/jean-slim.svg', marca: 'Pionier' },
  { nombre: 'Jean Baggy', desc: 'Corte suelto con actitud. La tendencia urbana del momento.', imagen: '/images/catalogo/jean-baggy.svg', marca: 'Tayssir' },
  { nombre: 'Jean Mom Fit', desc: 'Tiro alto y pierna cónica. Comodidad retro para ella.', imagen: '/images/catalogo/jean-mom.svg', marca: 'Denimlab' },
  { nombre: 'Jean Skinny', desc: 'Ajuste ceñido, tela stretch. Silueta definida y moderna.', imagen: '/images/catalogo/jean-skinny.svg', marca: 'Pionier' },
]
  ...
  return (
    <main className="bg-dark min-h-screen">
      ...
      <section className="relative h-[60vh] sm:h-[70vh] min-h-[400px] flex items-end overflow-hidden">
        <Image
          src="/images/hero/hero-lg.png"
          alt="Catálogo Club Karolay Jeans"
          fill
          className="object-cover"
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-t from-mocha-950 via-black/40 to-black/30" />
